...
# 5 "color_management.c" 2
# 1 "system.h" 1
# 6 "color_management.c" 2
...
# 8 "color_management.c" 2


void config_clut() {
# 19 "color_management.c"
    G1CLUTbits.CLUTEN = 1;
}
void clut_set(uint8_t index, uint16_t color) {
    G1CLUTbits.CLUTADR = index;
    G1CLUTbits.CLUTRWEN = 1;
    G1CLUTWR = color;
    while(G1CLUTbits.CLUTBUSY) continue;
