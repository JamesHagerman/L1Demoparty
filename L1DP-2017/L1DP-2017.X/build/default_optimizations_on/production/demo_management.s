...
.LC0:
	.asciz	"Oops! Trying to add too many scenes!"
	.section	.text,code
	.align	2
	.global	_addScene	; export
	.type	_addScene,@function
_addScene:
.LFB1:
.LSM0:
	.set ___PA___,1
...
.LSM2:
	inc.b	w4,w4
	mov	#_story_state+164,w5
	mov.b	w4,[w5]
.LSM3:
	ze	w4,w4
	sl	w4,#5,w4
	mov	#_story_state+4,w5
	add	w5,w4,w7
	mov	#-38,w6
	add	w15,w6,w6
	repeat	#16-1
...
.LC4:
	.asciz	"Scene ran too long. Resetting frames counter to 0..."
	.section	.text,code
	.align	2
