...
void setSampleRate(SAMPLE_RATES newRate) {
    // Note: Absolute fastest rate seems to be PR1 = 1 which would give us a 
    // sample rate of 16MHz.
    switch (newRate) {
//        case LOW:
...
//        case MAX:
//        default:
//            currentPhaseTable = phaseTableMAX;
//            PR1 = 1; // 16000000: 1
//            break;
    }
}
...
void ncoSetFreq(NCO *n, float freq) {
    // Set the sample rate of this NCO in Hz (11025, 22050, 44100, 16MHz)
    //
    ...
    //
    // 32 bit accumulator split into two chunks:
    // 256 table entries (8bits), 24 bits of fractional index; 2^24 = 16777216
...
void ncoInit(NCO *n, float freq, uint8_t wavetableIndex, uint8_t muteLevel) {
    ...
    n->mute = muteLevel;
    ncoSetFreq(n, freq); // This actually sets the sample rate...
}
...
// 
// Note that these tables represent "How far to jump through the wave table for
// any given note/frequency". They are dependant on Sample rate because the 
// smallest increment of the phase accumulator will make it roll over to zero
// at different speeds based on the sample rate.
//
// 16MHz sample rate
//uint32_t phaseTableMAX[] = {
//    // Real data:
//    2195.174310085124, 2325.676435673637, 2463.938621470109, 2610.4223046669176, 
//    2765.6163609397554, 2930.0387360247482, 3104.238174314198, 3288.796050239989, 
//    3484.3283085567086, 3691.48752, 3910.9650591807404, 4143.493411983533, 
//    4389.848620170248, 4650.852871347274, 4927.377242940218, 5220.344609333835, 
//    5530.732721879511, 5859.5774720494965, 6207.976348628396, 6577.092100479978, 
//    6968.156617113417, 7382.47504, 7821.4301183614825, 8286.486823967063, 
//    8779.197240340496, 9301.205742694548, 9854.254485880432, 10440.18921866767, 
//    11060.965443759025, 11718.654944098991, 12415.452697256793, 13153.68420095996, 
//    13935.813234226833, 14764.45008, 15642.360236722965, 16572.473647934126, 
//    17557.894480680992, 18601.911485389097, 19708.008971760864, 20879.87843733534, 
//    22121.43088751805, 23436.809888197982, 24830.405394513586, 26306.86840191992, 
//    27871.126468453665, 29528.40016, 31284.22047344593, 33144.44729586826, 
//    35115.288961361985, 37203.322970778194, 39415.517943521736, 41759.25687467068, 
//    44242.36177503609, 46873.119776395964, 49660.31078902717, 52613.236803839834, 
//    55741.75293690733, 59056.30032, 62567.94094689186, 66288.39459173652, 
//    70230.07792272397, 74406.14594155639, 78830.53588704347, 83518.01374934136, 
//    88484.22355007219, 93745.73955279193, 99320.12157805434, 105225.97360767967, 
//    111483.00587381466, 118112.10064, 125135.38189378372, 132576.28918347304, 
//    140459.65584544794, 148811.79188311278, 157660.57177408694, 167035.52749868273, 
//    176967.94710014437, 187490.97910558386, 198639.74315610869, 210451.44721535934, 
//    222965.51174762932, 236223.70128, 250270.26378756744, 265152.0783669461, 
//    280918.8116908959, 297623.08376622555, 315320.6435481739, 334070.55499736546, 
//    353935.39420028875, 374981.4582111677, 397278.98631221737, 420902.3944307187, 
//    445930.52349525865, 472446.90256, 500540.0275751349, 530303.656733892, 
//    561837.1233817918, 595245.6675324511, 630640.7870963477, 668140.6099947309, 
//    707870.2884005776, 749962.4164223354, 794557.4726244347, 841804.2888614375, 
//    891860.5469905173, 944893.30512, 1001079.5551502698, 1060606.813467784, 
//    1123673.7467635835, 1190490.8350649022, 1261281.0741926953, 1336280.7199894618, 
//    1415740.0768011552, 1499924.3328446709, 1589114.4452488695, 1683608.077722875, 
//    1783720.5939810346, 1889786.11024, 2002158.610300539, 2121213.126935569, 
//    2247346.993527167, 2380981.1701298044, 2522561.6483853916, 2672560.9399789236, 
//    2831479.6536023095, 2999848.165689342, 3178228.390497739, 3367215.655445749,
//};
